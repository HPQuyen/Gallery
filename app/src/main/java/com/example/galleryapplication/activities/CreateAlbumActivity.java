...
public class CreateAlbumActivity extends AppCompatActivity {
    ...
    private void init() {
        Toolbar toolbar = findViewById(R.id.addAlbumToolbar);
        ...
        albumInputLayout = findViewById(R.id.albumCreateNameInputLayout);
        albumNameEditText = findViewById(R.id.albumCreateNameEditText);
        ...
        selectedTextView = findViewById(R.id.numberAddPhotosToAlbum);
